...
class HeaderComponent(BaseComponent):
    ...
    main_page_locator: Locators = (By.XPATH, "//div[2]/div/a")
    ...
    ubs_courier_link_locator: Locators = (By.XPATH, "//div/nav/ul/li[6]/a")
    ...
    def click_main_page_link(self) -> "MainPage":
        """Click the event link in the header and return an instance of the MainPage."""
    ...
    def click_places_link(self) -> "PlacesPage":
        """Click the event link in the header and return an instance of the PlacesPage."""
    ...
    def click_about_us_link(self) -> "AboutUsPage":
        """Click the event link in the header and return an instance of the AboutUsPage."""
    ...
    def click_my_space_link(self) -> "MySpaceAbstractPage":
        """Click the event link in the header and return an instance of the MySpaceAbstractPage."""
    ...
    def click_ubs_courier_link(self) -> "UBSCourierPage":
        """Click the event link in the header and return an instance of the UBSCourierPage."""
