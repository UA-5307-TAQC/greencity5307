...
class HabitProgressFormComponent(BaseComponent):
    ...
    progress_bar_locator: Locators = (By.CLASS_NAME, "days-duration")
    slider_locator: Locators = (By.XPATH, ".//input[@type='range']")
    invite_friends_btn_locator: Locators = (By.CLASS_NAME, "icon-plus-grey")

    edit_to_do_btn_locator: Locators = (By.CLASS_NAME, "edit-icon")
    to_do_field_locator: Locators = (By.CLASS_NAME, "add-field")
    add_to_do_btn_locator: Locators = (By.CLASS_NAME, "add-btn")
    ...
    def __init__(self, root: WebElement):
        ...
        self.to_do_field = self.root.find_element(*self.to_do_field_locator)
        self.add_to_do_btn = self.root.find_element(*self.add_to_do_btn_locator)
        self.save_to_do_btn = self.root.find_element(*self.save_to_do_btn_locator)


    def get_calendar(self) -> CalendarComponent:
        """Get calendar of Habit page."""
    ...
    def add_to_do_item(self, text: str):
        ...
        self.to_do_field.send_keys(text)
        self.add_to_do_btn.click()
        self.save_to_do_btn.click()
