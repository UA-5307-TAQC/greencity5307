"""Validation of like or remove of like for eco new by id"""
...
@allure.feature("LikeUnlikeEcoNew")
@allure.story("Like and remove like from new")
@allure.title("Like or unlike new by id.")
def test_like_remove_like_eco_new_by_id(news_id, status_code, message, access_token):
    """Test for validation of like or remove of like for eco new by id"""
    client = EcoNewClient(base_url=Config.BASE_API_URL, access_token=access_token)
    response = client.like_remove_like_eco_new_by_id(news_id=news_id)
