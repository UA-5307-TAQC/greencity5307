"""Social network image creation forbidden verification"""
...
@allure.title("Check creation of social network image without permission")
@pytest.mark.api
def test_create_social_network_image_forbidden(access_token):
    """Test for forbidden creation of social network image"""
    token = access_token
    ...
    with allure.step("Send POST request to create social network image"):
        response = client.create_social_network_image(body=body)
