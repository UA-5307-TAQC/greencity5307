...
from components.abstract_pages_components.friend_users_components \
    .mutual_habits_component import MutualHabitsComponent
...
class MutualHabitsPage(BasePage):
    ...
    page_title_locator: Locators = (By.CSS_SELECTOR,
                                    ".gallery.ng-star-inserted")
