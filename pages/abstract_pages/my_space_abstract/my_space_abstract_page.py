...
from pages.abstract_pages.my_space_abstract.my_events import \
    MyEventsPage
...
class MySpaceAbstractPage(BasePage):
    ...
    locators = {
        ...
        "to_do_list": (By.CSS_SELECTOR, "div.profile-container",
                       ToDoListComponent),
        "my_habits_tab": (By.XPATH,
                          ".//div[@class='mat-mdc-tab-labels']/div[1]"),
        "my_news_tab": (By.XPATH,
                        ".//div[@class='mat-mdc-tab-labels']/div[2]"),
        "my_events_tab": (By.XPATH,
                          ".//div[@class='mat-mdc-tab-labels']/div[3]"),
        "content": (By.CSS_SELECTOR,
                    "div.mat-mdc-tab-body-wrapper:nth-child(2)"),
