...
class SavedEventsPage(SavedAbstract):
    ...
    def filters(self):
        ...
        from components.events_components.events_filter_component import EventsFilterComponent  # pylint: disable=import-outside-toplevel
    ...
    def get_event_card_by_name(self, name: str):
        ...
        from components.events_components.event_card_component import EventCardComponent  # pylint: disable=import-outside-toplevel
    ...
    def change_view_style_buttons(self):
        ...
        from components.common_components.change_view_component import ChangeViewComponent  # pylint: disable=import-outside-toplevel
