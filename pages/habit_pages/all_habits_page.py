...
from components.habbit_components.all_habits.change_view_component \
    import ChangeViewComponent
from components.habbit_components.all_habits.create_habit_button_component \
    import CreateHabitButtonComponent
from components.habbit_components.all_habits.habit_card_component \
    import HabitCardComponent
from components.habbit_components.all_habits.habit_filter_component \
    import HabitFilterComponent
...
class AllHabitPage(BasePage):
    ...
    change_view_container_locator: Locators = (By.TAG_NAME,
                                               "app-change-view-button")
    habit_cards_locator: Locators = (By.CSS_SELECTOR, "app-habits-gallery-view > div,\
     app-habits-list-view > div")
    breadcrumbs_container_locator: Locators = (By.CLASS_NAME,
                                               "breadcrumbs-container")
    create_habit_button_locator: Locators = (By.CSS_SELECTOR,
                                             "div.habit-header > button")
    ...
    def get_create_habit_button(self) -> CreateHabitButtonComponent:
        ...
        create_habit_button = self.driver.find_element(
            *self.create_habit_button_locator)
