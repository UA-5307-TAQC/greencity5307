...
class PlacesPage(BasePage):
    ...
    add_place_modal_locator: Locators = (By.CSS_SELECTOR,
                                         ".ng-star-inserted > .form-container")

    def __init__(self, driver: WebDriver):
        super().__init__(driver)
        self.add_place_button: WebElement = self.driver.find_element(
            *self.add_place_button_locator)
    ...
    def open_add_place_modal(self) -> "AddPlaceModalComponent":
        ...
        return AddPlaceModalComponent(
            self.driver.find_element(*self.add_place_modal_locator))
